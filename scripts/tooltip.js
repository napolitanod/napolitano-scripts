...
const OVERRIDES = {
    ...
    ,'Eldritch Blast': 'Roll this item and then follow prompts for selecting targets (number of targets is based on your level).'
    ...
    ,'Scorching Ray': 'Roll this item and then follow prompts for selecting targets (up to 3 targets plus an additional one per spell slot spent above level 3).'
