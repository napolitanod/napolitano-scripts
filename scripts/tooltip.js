...
const OVERRIDES = {
    ...
    ,'Radiant Soul': 'Roll item to gain effect. You will be prompted for damage when your attack hits.'
    ...
    ,'Thunder Step': 'Before rolling this item, move your token and, if applicable, a friendly token to the targeted teleport space. Then, roll item and place template for damage.'
